...
/**
 * useCursorTrack — generic cursor-tracking 3D rotation for any component.
 *
 ...
 * existing CSS hover rule picks them up (element-level vars override :root).
 *
 * @param prefix     CSS var prefix, e.g. "card" → sets --vita-card-hover-rotate-x
